...
# **Description de l'application Taskforce**
...
- **Graphiques interactifs :**
  ...
  - Affichez des graphiques en ligne et en anneau pour visualiser la répartition des tâches par statut ou par semaine.
  - Analysez les performances sur les 8 dernières semaines ou les 12 derniers mois.
...
- **Thème cyberpunk :**
  ...
  - Couleurs dominantes : cyan, rouge et noir.
  - Effets lumineux et transitions fluides pour une expérience immersive.
...
- **Frontend :**
  ...
  - React avec TypeScript pour une interface utilisateur robuste et maintenable.
  - PrimeReact pour des composants UI interactifs.
  - React Router pour la gestion des routes.

- **Backend :**

  - API REST pour la gestion des données et l'authentification.

- **Autres outils :**
  - React Toastify pour les notifications.
  - Date-fns pour la gestion des dates.
  - CSS personnalisé pour le thème cyberpunk.
